...
function AlHamdLogo({ className = "h-16 md:h-20" }: { className?: string }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans selection:bg-amber-500 selection:text-white">
      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md shadow-sm border-b border-slate-100 transition-all">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-slate-100 px-4 pt-2 pb-6 space-y-3 shadow-lg absolute w-full left-0">
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative bg-slate-800/90 border border-slate-700 rounded-2xl p-6 sm:p-8 shadow-2xl backdrop-blur-sm">
                ...
                {contactSubmitted && (
                  <div className="absolute inset-0 bg-slate-900/95 rounded-2xl flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <span className="text-xs tracking-widest text-amber-600 font-extrabold uppercase block">Who We Are</span>
      ...
      <section id="services" className="py-20 lg:py-28 bg-slate-100 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            <span className="text-xs tracking-widest text-amber-600 font-bold uppercase block">Diversified Portfolio</span>
      ...
      <section id="projects" className="py-20 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            <div>
              <span className="text-xs tracking-widest text-amber-600 font-bold uppercase block mb-2">Showcase</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
      ...
      <section id="estimator" className="py-20 lg:py-28 bg-slate-900 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-4">
            <span className="text-xs tracking-widest text-amber-500 font-extrabold uppercase block">Budget Calculator</span>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="h-3 w-full rounded-full bg-slate-700 overflow-hidden flex">
                      ...
                      <div className="h-full bg-slate-300" style={{ width: '30%' }} />
      ...
      <section className="py-20 lg:py-28 bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              <span className="text-xs tracking-widest text-amber-600 font-bold uppercase block">Leader Message</span>
              <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
      ...
      <section id="values" className="py-20 lg:py-28 bg-slate-50 border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto mb-16 space-y-3">
            <span className="text-xs tracking-widest text-amber-600 font-bold uppercase block">Our Principles</span>
            <h2 className="text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">Values That Build Our Success</h2>
            <p className="text-slate-600 text-sm">We ensure each structural execution complies with strict quality metrics.</p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { title: 'Excellence in Execution', desc: 'From initial foundation concrete mixes to final elite farm house plaster coatings, we strive for zero errors and perfect alignment.' },
              { title: 'Transparent Partnership', desc: 'Cultivating authentic, collaborative partnerships with our clients, ensuring budgets match deliverables without surprise markups.' },
              { title: 'Continuous Improvement', desc: 'Embracing modern concrete casting methodologies, specialized structural tools, and eco-friendly treatment procedures.' },
              { title: 'Commitment to Growth', desc: 'Supporting the local Pakistani workforce, fostering expert skills, and offering robust training structures for our construction crew.' },
              { title: 'Client Satisfaction', desc: 'Achieving client handover schedules exactly on plan. Delivering properties on time and within agreed budget parameters.' },
              { title: 'Social Responsibility', desc: 'Promoting eco-friendly filtration structures and building systems minimizing carbon runoffs in critical industrial environments.' }
            ].map((val, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-12 items-stretch">
            <div className="lg:col-span-5 flex flex-col justify-between space-y-8">
              <div>
                <span className="text-xs tracking-widest text-amber-600 font-bold uppercase block mb-2">Locate Us</span>
      ...
      <footer className="bg-slate-950 text-slate-400 pt-16 pb-8 border-t border-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-3 space-y-3 pt-4">
            ...
            <p className="text-xs text-slate-500">Near Total Petroleum, Jaranwala Road, Khurrianwala, Pakistan.</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-t border-slate-900/60 pt-8 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-slate-600">
          <div>&copy; {new Date().getFullYear()} ALHAMD BUILDERS. All Rights Reserved.</div>
